...
class App extends React.Component {
  ...
  validateTelly = () => {
    ...
    if(!this.state.tel || !validator.isMobilePhone(this.state.tel)) {
      errors.telly = 'Not a valid phone number'
    }
    return errors
  }
  validateWeight = () => {
  ...
  render() {
    ...
    const { telly } = this.validateTelly()
    const { weight } = this.validateWeight()
